...
- (void)viewDidLoad {
    ...
    checked = NO;
    _txtUserName.text=[[NSUserDefaults standardUserDefaults]objectForKey:@"name"];
    _txtEmailid.text=[[NSUserDefaults standardUserDefaults]objectForKey:@"email"];
    ...
    self.txtEmailid.textColor=[UIColor purpleColor];
...
- (IBAction)RegisterClicked:(id)sender
{
    ...
    else
    {
        ...
        [profile appendString:[NSString stringWithFormat:@"&fb_id=%@", [[NSUserDefaults standardUserDefaults]objectForKey:@"ID"]]];
        [profile appendString:[NSString stringWithFormat:@"&register_with=%@", @"facebook"]];
