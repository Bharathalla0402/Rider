...
- (void)viewDidLoad {
    ...
    checked = NO;
    _txtUserName.text=[[NSUserDefaults standardUserDefaults]objectForKey:@"gmailname"];
...
- (IBAction)RegisterClicked:(id)sender
{
    ...
    else
    {
        ...
        [profile appendString:[NSString stringWithFormat:@"&fb_id=%@", [[NSUserDefaults standardUserDefaults]objectForKey:@"usergmail"]]];
        [profile appendString:[NSString stringWithFormat:@"&register_with=%@", @"google"]];
